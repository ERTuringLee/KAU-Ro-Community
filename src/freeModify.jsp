	...
	<div id="page-wrapper">
		...
		<div id="content">
			<div id="left-section">
				...
				<br />
				<div align="center">
				<form action="freeMo.jsp" method="post"  id='freeform' enctype="multipart/form-data" >
				<%
					String idNum=request.getParameter("id");
					hid = Integer.parseInt(idNum);
					st = conn.createStatement();
					try{
					rs = st.executeQuery("select * from board where id="+hid);
					while(rs.next()){
