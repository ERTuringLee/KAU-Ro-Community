	...
	<div id="page-wrapper">
		...
		<div id="content">
			<div id="left-section">
				...
				<br />
				<div align="center">
				<form action="secondhandMo.jsp" method="post"  id='secondhandform' enctype="multipart/form-data" >
				<%
					String idNum=request.getParameter("id");
					hid = Integer.parseInt(idNum);
					st = conn.createStatement();
					try{
					rs = st.executeQuery("select * from secondhand where id="+hid);
					while(rs.next()){
				...
				<script>
					$(document).ready(function () {
						...
						$('#cancel').click(function () {
							location.href ="secondhand.jsp?id=<%=hid%>";
						})
