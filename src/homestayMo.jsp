...
<%
	...
	try{
		...
		st.executeUpdate("update homestay set title='"+title+"',content='"+content+"',name='"+writer+"',date="+date+", file='homestay/"+newFile.getName()+"', password='"+password+"' where id="+multi.getParameter("id"));
	}catch(SQLException e){
		out.println(e.getMessage());
	}
	st.close();
	conn.close();
	response.sendRedirect("homestay.jsp?id="+multi.getParameter("id"));
%>