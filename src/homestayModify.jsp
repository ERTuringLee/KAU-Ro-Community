	...
	<div id="page-wrapper">
		...
		<div id="content">
			<div id="left-section">
				...
				<br />
				<div align="center">
				<form action="homestayMo.jsp" method="post"  id='homestayform' enctype="multipart/form-data" >
				<%
					String idNum=request.getParameter("id");
					hid = Integer.parseInt(idNum);
					st = conn.createStatement();
					try{
					rs = st.executeQuery("select * from homestay where id="+hid);
					while(rs.next()){
						...
						out.println("<td><input type='text' style='width:99%;' id='writer' name='writer' value='"+rs.getString("name")+"'></td>");
						out.println("<th>비밀번호</th>");
						out.println("<td><input type='password' style='width:99%;' id='password' name='password' value='"+rs.getString("password")+"'></td>");
						out.println("</tr>");
						out.println("<tr>");
				...
				<script>
					$(document).ready(function () {
						...
						$('#cancel').click(function () {
							location.href ="homestay.jsp?id=<%=hid%>";
						})
